...
public class AL_Portal : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        GameManager.instance.addCollisionScore(EntityType.BLOCK_PORTAL);

        var cd = other.GetComponent<AL_PortalCooldown>();
        ...
        if (cd == null) cd = other.gameObject.AddComponent<AL_PortalCooldown>();
        cd.lastTeleportTime = Time.time;
    }
}

public class AL_PortalCooldown : MonoBehaviour
{
